...
import chigo from './assets/Chigo.png';


const Partners = () => {
  return (
<section id="partners" className="bg-lime-200 py-16">
        <div className="container mx-auto px-4 text-center">
          
          <h3 className="text-sm font-semibold text-gray-500 tracking-widest uppercase mb-8">
            Trusted By The Best
          </h3>
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8">
            ...
            <img className="max-h-20 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 hover:scale-110 transition-all duration-300" src={chigo} alt="chigo" />
